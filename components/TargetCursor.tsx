...
const TargetCursor: React.FC<TargetCursorProps> = ({
    ...
    useEffect(() => {
        ...
        const mouseDownHandler = () => {
            ...
            gsap.to(dotRef.current, { scale: 0.4, duration: 0.2 });
            gsap.to(cursorRef.current, { scale: 0.7, duration: 0.15 });
        };
    ...
    return (
        ...
        >
            <div
                ...
                style={{ willChange: 'transform', backgroundColor: '#a855f7', boxShadow: '0 0 10px #a855f7' }}
            />
            <div
                ...
                style={{ willChange: 'transform', borderColor: '#a855f7', filter: 'drop-shadow(0 0 4px #a855f7)' }}
            />
            <div
